...
from flaskr.vistas import VistaCliente, VistaProducto, VistaPQR, VistaInformes, VistaAnomalia, VistaSignUp, VistaLogIn, VistaCertificador, VistaTokens
...
api.add_resource(VistaTokens, '/guardar-historial-tokens')
